...
const res = await axios.post("http://localhost:1010/user_info",obj);
console.log(res);
  ...
  const formsubmit = async (e) => {
    ...
    if (
      ...
      NotificationManager.error("Please Feel Required Fields");
        ...
        const res = await axios.post("http://localhost:1010/updateprofile", formData);
      // console.log(res);
