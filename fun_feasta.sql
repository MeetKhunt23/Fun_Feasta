...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2023 at 09:15 AM
...
INSERT INTO `admin` (`id`, `user_id`, `name`, `contact`, `create_date`) VALUES
(1, 1, 'Meet', '9825577872', '2023-06-15 10:32:04'),
(2, 2, 'Trusha', '9106689874', '2023-06-15 10:39:15');
...
INSERT INTO `comments` (`id`, `user_id`, `event_id`, `comment`, `create_date`) VALUES
(28, 2, 18, 'Nice Baby', '2023-06-26 07:48:57'),
(29, 1, 18, 'You are Cute @trusha', '2023-06-26 07:49:49');
...
INSERT INTO `events` (`id`, `event_name`, `image`, `entry_fee`, `event_date`, `event_time`, `event_place`, `contact_person`, `contact_no`, `capacity`, `create_date`) VALUES
(15, 'Swimming', '96333underwater-shot-of-swimmer-training-in-the-pool-royalty-free-image-620959526-1553098887.jpg', 200.00, '2023-02-24', '09:00:00', 'Rajkot', 'Meet', '9106689874', 1000, '2023-06-21 06:47:22'),
(17, 'Kho-kho', '6231251xLyHuokuL.jpg', 200.00, '2023-06-23', '18:12:00', 'Rajkot', 'Meet', '9106689874', 200, '2023-06-22 11:44:36'),
(18, 'Hockey', '7601392794226.webp', 200.00, '2023-06-27', '10:55:00', 'Rajkot', 'Meet', '9106689874', 200, '2023-06-23 05:26:25'),
(19, 'Cricket', '7312gettyimages-166080748-612x612.jpg', 200.00, '2023-06-27', '16:30:00', 'Rajkot', 'Meet', '9106689874', 500, '2023-06-23 09:06:01'),
(20, 'football', '56023ARFF23-Hero-Cover-300.jpg', 500.00, '2023-06-23', '18:59:00', 'rajkot', 'Meet', '9100688955', 2500, '2023-06-23 10:30:33'),
(21, 'Table tennis', '2412916804074-two-players-play-table-tennis.webp', 200.00, '2023-06-29', '15:08:00', 'Rajkot', 'Meet', '9106689874', 1000, '2023-06-23 18:37:00');

-- --------------------------------------------------------

--
-- Table structure for table `liked_events`
--
...
--
-- Dumping data for table `liked_events`
--

INSERT INTO `liked_events` (`id`, `user_id`, `event_id`, `create_date`) VALUES
(77, 2, 19, '2023-06-26 07:49:12'),
(78, 2, 18, '2023-06-26 07:49:13'),
(79, 2, 21, '2023-06-26 07:49:14'),
(83, 7, 19, '2023-06-26 10:31:33'),
(84, 7, 18, '2023-06-26 10:31:45'),
(88, 1, 19, '2023-06-27 06:10:46'),
(89, 1, 18, '2023-06-27 06:41:10');
...
CREATE TABLE `tickets` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '1-booked,cancel-0',
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tickets` (`id`, `user_id`, `event_id`, `quantity`, `total`, `status`, `create_date`) VALUES
(144, 1, 21, 1000.00, 200000.00, 0, '2023-06-27 04:23:46'),
(145, 1, 18, 200.00, 40000.00, 1, '2023-06-27 05:41:04');
...
CREATE TABLE `users` (
  ...
  `device_type` int(12) NOT NULL,
  `device_token` int(12) NOT NULL,
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `mobile`, `email`, `password`, `gender`, `profile_picture`, `address_id`, `country_id`, `state_id`, `city_id`, `device_type`, `device_token`, `create_date`) VALUES
(1, 'Meet', 'Khunt', '9825577872', 'meetkhunt2301@gmail.com', '91066', 1, 'Capture.JPG', 0, 101, 1, 10, 0, 0, '2023-06-15 07:32:08'),
(2, 'Trusha', 'Thummar', '9106689874', 'rahulgondaliya268@gmail.com', '778760', 0, 'Capture1.PNG', 0, 101, 1, 1, 0, 0, '2023-06-15 10:37:46'),
(5, 'Rahul', 'Gondaliya', '9857487554', 'rahul@gmail.com', 'rahul123', 1, '9703kee movie.png', 0, 101, 7, 1884, 0, 0, '2023-06-20 06:24:47'),
(6, 'Trusha', 'Thummar', '910668987445', 'trushatmer@gmail.comm', '98255', 0, '2287551xLyHuokuL.jpg', 0, 101, 1, 1, 0, 0, '2023-06-26 10:11:51'),
(7, 'msmdfm', ',efs,fms', '9585478578', 'meer@com.com', 'mee@12', 1, '55053images (7).jpg', 0, 101, 12, 952, 0, 0, '2023-06-26 10:31:05');
...
--
-- Indexes for table `liked_events`
--
ALTER TABLE `liked_events`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `liked_events`
--
ALTER TABLE `liked_events`
